...
import { canAccessOnboardingSurface, canReadAuditLog } from "@/lib/shared/workforce-auth";
...
export const canViewInternalAdmin = (me: SessionMe | null): boolean => canAccessOnboardingSurface(me);

export const canViewAuditLog = (me: SessionMe | null): boolean => canReadAuditLog(me);
