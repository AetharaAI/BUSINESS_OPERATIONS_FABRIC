...
1. Internal admin route: `/internal-admin` (authenticated session must resolve internal-admin access from VoiceOps auth payload: `role=admin` or `is_platform_admin=true`).
